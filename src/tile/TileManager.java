...
public class TileManager {
	...
	public void loadMap(String filePath) {
		...
		try {
			InputStream is = getClass().getResourceAsStream(filePath); //Input Stream: import file txt
			BufferedReader br = new BufferedReader(new InputStreamReader(is)); //BufferedReader read a contain in txt file
